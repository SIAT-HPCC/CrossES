...
from enhance.replicaexchange import ReplicaExchange
...
simulation.reporters.append(PDBReporter('out/out%i.pdb' % (rank), savepdbstep))
simulation.reporters.append(StateDataReporter('out/md%i.log' % (rank), savelogstep, step=True, potentialEnergy=True, kineticEnergy = True, totalEnergy = True, temperature=True, speed = True))
